...
module.exports = {
  // _2 suffix = Ladysmith's own agents. Deliberately NOT falling back to
  // Dundee's ORDERS_AGENT_NUMBER/SUPPORT_AGENT_NUMBER — if _2 isn't set,
  // messages should go to an obvious placeholder, not silently to Dundee's
  // staff.
  ORDERS_AGENT: process.env.ORDERS_AGENT_NUMBER_2 || "27000000001",
  SUPPORT_AGENT: process.env.SUPPORT_AGENT_NUMBER_2 || "27000000002",
