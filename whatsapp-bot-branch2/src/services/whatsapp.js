...
// _2 suffix = Ladysmith's own WABA credentials. GRAPH_API_VERSION isn't a
// secret and rarely differs per branch, so it falls back to the unsuffixed
// value (and then the default) rather than requiring a duplicate.
const {
  WHATSAPP_TOKEN_2: WHATSAPP_TOKEN,
  WHATSAPP_PHONE_NUMBER_ID_2: WHATSAPP_PHONE_NUMBER_ID,
  GRAPH_API_VERSION_2,
  GRAPH_API_VERSION: GRAPH_API_VERSION_DUNDEE,
} = process.env;
const GRAPH_API_VERSION = GRAPH_API_VERSION_2 || GRAPH_API_VERSION_DUNDEE || "v20.0";
