...
import { Building2, User, Upload, Check, AlertCircle, TrendingUp } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const [expectedAnnualSpend, setExpectedAnnualSpend] = useState('');
  ...
  const fetchBranch = async () => {
    try {
      ...
      if (!res.ok) { toast.error('Branch not found'); router.push('/'); return; }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (type === 'wholesale' && (!businessName || !contactPerson || !street || !city)) {
      ...
      if (type === 'wholesale') {
        const wholesaleRes = await fetch('/api/wholesale/customers', {
          ...
          body: JSON.stringify({
            ...
            email,
            phone,
            expectedAnnualSpend: expectedAnnualSpend ? Number(expectedAnnualSpend) : null,
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link href="/" className="text-brand-orange hover:text-orange-600 font-semibold">Go to Home</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`p-4 rounded-xl border-2 transition-all ${type === 'retail' ? 'border-brand-orange bg-orange-50' : 'border-gray-200 hover:border-gray-300'}`}
            >
            ...
            <button
              ...
              className={`p-4 rounded-xl border-2 transition-all ${type === 'wholesale' ? 'border-brand-orange bg-orange-50' : 'border-gray-200 hover:border-gray-300'}`}
            >
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 shadow-sm space-y-6">
          {type === 'wholesale' ? (
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" required className="input-field" value={businessName} onChange={(e) => setBusinessName(e.target.value)} placeholder="e.g., Sunny's Tuckshop" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Business Type *</label>
                    <select required className="input-field" value={businessType} onChange={(e) => setBusinessType(e.target.value as any)}>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" className="input-field" value={registrationNumber} onChange={(e) => setRegistrationNumber(e.target.value)} placeholder="Optional" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">VAT Number</label>
                      <input type="text" className="input-field" value={vatNumber} onChange={(e) => setVatNumber(e.target.value)} placeholder="Optional" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setExpectedAnnualSpend(e.target.value)}
                      placeholder="e.g. 120000"
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      This helps us determine your account type and credit eligibility.
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" required className="input-field" value={contactPerson} onChange={(e) => setContactPerson(e.target.value)} placeholder="Contact person's name" />
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                      <input type="email" required className="input-field" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="contact@business.com" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Phone Number *</label>
                      <input type="tel" required className="input-field" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="0XX XXX XXXX" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" required className="input-field" value={street} onChange={(e) => setStreet(e.target.value)} placeholder="123 Main Street" />
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">City *</label>
                      <input type="text" required className="input-field" value={city} onChange={(e) => setCity(e.target.value)} placeholder="Durban" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Province *</label>
                      <select required className="input-field" value={province} onChange={(e) => setProvince(e.target.value)}>
                  ...
                  <div>
                    ...
                    <input type="text" required className="input-field" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} placeholder="4001" />
                  </div>
                </div>
              </div>
            </>
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                  <input type="email" required className="input-field" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="john@example.com" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                  <input type="tel" className="input-field" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="0XX XXX XXXX" />
                </div>
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="password" required className="input-field" value={password} onChange={(e) => setPassword(e.target.value)} minLength={6} placeholder="••••••••" />
                <p className="text-xs text-gray-500 mt-1">Minimum 6 characters</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Confirm Password *</label>
                <input type="password" required className="input-field" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} minLength={6} placeholder="••••••••" />
              </div>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <Link href={type === 'wholesale' ? `/${slug}/wholesale/login` : `/${slug}/login`} className="text-brand-orange hover:text-orange-600 font-semibold">
              Login here
            </Link>
          </p>
        </form>
