        ...
        <div className="max-w-3xl mx-auto px-4 py-16">
          <div className="bg-white rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={branch ? `/${branch.slug}/shop` : '/shop'} className="btn-primary">
                Continue Shopping
              </Link>
              {user && (
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-16">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg text-center mb-8">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8">
            Thank you for your purchase from {branch?.displayName || 'our store'}. Your order has been successfully placed.
          </p>
              ...
              {order.items.map((item: any, index: number) => (
                <div key={index} className="flex items-center space-x-3 md:space-x-4 pb-4 border-b last:border-b-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-sm md:text-base text-brand-black line-clamp-2">
                      {item.name || 'Product'}
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 md:p-8 shadow-lg mb-8 text-white">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/90 mb-4 text-sm md:text-base">
                  View detailed order status, track delivery, and access your complete order history.
                </p>
                <Link 
                  href="/account/orders"
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link 
            href={branch ? `/${branch.slug}/shop` : '/shop'} 
            className="btn-primary flex-1 text-center py-4 flex items-center justify-center space-x-2"
          >
